    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 0:
                ...
                title = getString(R.string.title_newsletters);
                break;
            case 1:
           ...
           /* case 2:
            ...
            case 2:
                ...
                break;
            case 3:
                fragment = new AdvertsFragments();
                title = getString(R.string.title_Adverts);
                break;
            case 4:
                fragment = new SchoolCalendarFragment();
                title = getString(R.string.title_school_calendar);
                break;
            case 5:
